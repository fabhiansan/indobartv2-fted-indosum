...
from transformers import (
    ...
    DataCollatorForLanguageModeling, # Use standard MLM collator for debugging
...
if __name__ == "__main__":
    ...
    #
    # --- Temporarily Comment Out Custom Collator for Debugging ---
    # @dataclass
    ...
    print("Initializing data collator (Using standard MLM for debugging)...")
    # Use standard MLM collator instead of the custom one
    data_collator = DataCollatorForLanguageModeling(
        tokenizer=tokenizer,
        mlm=True, # Enable MLM
        mlm_probability=0.15, # Standard MLM probability
        pad_to_multiple_of=8 if training_args.fp16 else None # Added padding argument
    )
    print("Data collator initialized (Using standard MLM).")

    # --- Verify Model Config Vocab Size Before Trainer --- # Keep this check
